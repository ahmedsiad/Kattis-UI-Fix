...
let auth_tot = document.querySelectorAll("body > main > div.l-report_grid > article > div > div.table-container > div > table > thead > tr > th:nth-child(8)")[0]
...
let auth_acc = document.querySelectorAll("body > main > div.l-report_grid > article > div > div.table-container > div > table > thead > tr > th:nth-child(9)")[0]
